...
public class Nominee_Details {
	...
	public Nominee_Details(int nominee_id, int owner_id, int owner_type, int seq_num, int nom_share, int nom_type,
			int nom_type_code, String nominee_first_name, String nominee_middle_name, String nominee_last_name,
			int rtln_type, int rtln_type_code, LocalDate date_of_birth, LocalDate last_update, int nom_add_id,
			String nom_doc_id, int ver) {
		super();
		this.nominee_id = nominee_id;
		this.owner_id = owner_id;
		this.owner_type = owner_type;
		this.seq_num = seq_num;
		this.nom_share = nom_share;
	...
	public void setNom_share(int nom_share) {
		this.nom_share = nom_share;
	}
